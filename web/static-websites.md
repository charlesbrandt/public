...
It’s a good idea to familiarize yourself with some of the basic concepts of HTML.  It's really not too scary.  It's a *markup* language, not a programming language.  Instead of selecting text in a word processor and pressing a "Bold" button, you surround the text with bold tags <b>like this</b>. 
...
documentation on github - Google Search
https://www.google.com/webhp?sourceid=chrome-instant&ion=1&espv=2&ie=UTF-8#q=documentation%20on%20github
...
github include documentation repository - Google Search
https://www.google.com/webhp?sourceid=chrome-instant&ion=1&espv=2&ie=UTF-8#q=github+include+documentation+repository
sphinx documentation no index - Google Search
https://www.google.com/webhp?sourceid=chrome-instant&ion=1&espv=2&ie=UTF-8#q=sphinx%20documentation%20no%20index
python markdown to html - Google Search
https://www.google.com/webhp?sourceid=chrome-instant&ion=1&espv=2&ie=UTF-8#q=python+markdown+to+html
trentm/python-markdown2
https://github.com/trentm/python-markdown2
Markdown 2.6.1 : Python Package Index
https://pypi.python.org/pypi/Markdown
Python Markdown
https://pythonhosted.org/Markdown/
markdown to html - Google Search
https://www.google.com/webhp?sourceid=chrome-instant&ion=1&espv=2&ie=UTF-8#q=markdown+to+html&start=50
Pandoc - Getting started with pandoc
http://johnmacfarlane.net/pandoc/getting-started.html
markdown static site generator - Google Search
https://www.google.com/webhp?sourceid=chrome-instant&ion=1&espv=2&ie=UTF-8#q=markdown%20static%20site%20generator
...
Overview
http://hyde.github.io/
python sphinx vs static site generators - Google Search
https://www.google.com/search?q=python+sphinx+vs+static+site+generators&oq=python+sphinx+vs+static+site+generators&aqs=chrome..69i57.6926j0j1&sourceid=chrome&es_sm=91&ie=UTF-8
StaticSiteGenerator - Python Wiki
https://wiki.python.org/moin/StaticSiteGenerator

*2015.03.26 18:35:28 static_generator node javascript
gulp less browsersync template - Google Search
https://www.google.com/search?q=gulp+less+boilerplate&oq=gulp+less+boilerplate&aqs=chrome..69i57.4590j0j1&sourceid=chrome&es_sm=91&ie=UTF-8#q=gulp+less+browsersync+template
Building With Gulp - Smashing Magazine
http://www.smashingmagazine.com/2014/06/11/building-with-gulp/
gulp static site generator - Google Search
https://www.google.com/search?q=node+static+site+generator&oq=node+static+site+generator&aqs=chrome..69i57.5134j0j1&sourceid=chrome&es_sm=91&ie=UTF-8#q=gulp+static+site+generator
Top Open-Source Static Site Generators - StaticGen
https://www.staticgen.com/
Brunch - ultra-fast HTML5 build tool
http://brunch.io/
brunch-with-chaplin/brunch-config.coffee at master · paulmillr/brunch-with-chaplin · GitHub
https://github.com/paulmillr/brunch-with-chaplin/blob/master/brunch-config.coffee
Metalsmith
