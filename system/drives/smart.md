...
*2014.03.26 10:26:06
For checking the S.M.A.R.T status of a drive on linux, this looks like a good tool:
...
Next, let’s make sure that the drive supports self-tests. I have yet to see a drive that doesn’t, but the following command also gives time estimates for each test:
